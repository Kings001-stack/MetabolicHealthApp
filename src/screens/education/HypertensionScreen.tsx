...
import { hypertensionContent } from '@/data/education';

const HypertensionScreen: React.FC = () => {
  const [searchQuery, setSearchQuery] = useState('');
  const [selectedDifficulty, setSelectedDifficulty] = useState<'all' | 'beginner' | 'intermediate' | 'advanced'>('all');

  const filteredContent = hypertensionContent.filter(item => {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.header}>
        <Text style={styles.title}>Hypertension Education</Text>
        <Text style={styles.subtitle}>Learn about blood pressure management</Text>
      </View>
      ...
      <Card style={styles.searchCard}>
        <Input
          ...
          placeholder="Search hypertension topics..."
        />
      </Card>
