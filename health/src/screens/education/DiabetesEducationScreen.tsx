...
import { diabetesContent } from '@/data/education';

const DiabetesEducationScreen: React.FC = () => {
  const [searchQuery, setSearchQuery] = useState('');
  const [selectedDifficulty, setSelectedDifficulty] = useState<'all' | 'beginner' | 'intermediate' | 'advanced'>('all');

  const filteredContent = diabetesContent.filter(item => {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.header}>
        <Text style={styles.title}>Diabetes Education</Text>
        <Text style={styles.subtitle}>Learn about diabetes management and prevention</Text>
      </View>
...
export default DiabetesEducationScreen;
